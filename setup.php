...
<form method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>" name="pppm_2_uninstall" >
  <tr>
    <td>
	<p><?php _e('You don\'t like   UPM HTML Tag Manager ?') ;?></p>
	<p><?php _e('No problem, before you deactivate this plugin press the Uninstall Button, because deactivating  UPM HTML Tag Manager does not remove any data that may have been created. ') ;?></p>
	</td>
  </tr>
  <tr>
